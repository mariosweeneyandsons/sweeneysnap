    ...
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-white/50 text-sm">Add individual crew members with specific permissions</p>
        </div>
      </div>
      ...
      <Card>
        ...
        <div className="flex items-center gap-2">
          <code className="text-xs text-white/60 bg-white/5 px-2 py-1 rounded flex-1 truncate">{legacyCrewUrl}</code>
