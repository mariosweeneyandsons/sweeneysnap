      ...
      <div className="flex items-center justify-between mb-8">
        {!collapsed ? (
          <Link href="/admin" onClick={onClose} className="group">
            <h2 className="text-lg font-bold text-foreground group-hover:text-primary transition-colors">SweeneySnap</h2>
            <p className="text-foreground-muted text-sm">Admin Panel</p>
          </Link>
        ) : (
          <Link href="/admin" onClick={onClose} className="mx-auto text-foreground-muted hover:text-foreground transition-colors" title="Dashboard">
