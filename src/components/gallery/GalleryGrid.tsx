            ...
            <div className="p-3 w-full opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0">
              ...
              {allowDownload && selfie.imageUrl && (
                <DownloadButton
                  ...
                  className="mt-2 px-3 py-1 rounded-xs bg-secondary hover:bg-secondary-hover text-white text-xs font-medium transition-colors inline-flex items-center gap-1.5"
                >
