  ...
  return (
    <div className="columns-2 md:columns-3 lg:columns-4 gap-3 space-y-3">
      {selfies.map((selfie, index) => (
        <div
          key={selfie._id}
          className="break-inside-avoid group relative rounded-xl overflow-hidden cursor-pointer bg-white/5"
            ...
            <div className="p-3 w-full opacity-0 group-hover:opacity-100 transition-opacity translate-y-2 group-hover:translate-y-0">
              ...
              {allowDownload && selfie.imageUrl && (
                <DownloadButton
                  ...
                  className="mt-2 px-3 py-1 rounded-lg bg-white/20 hover:bg-white/30 text-white text-xs font-medium transition-colors inline-flex items-center gap-1.5"
                >
